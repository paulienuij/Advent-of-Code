data = [[116,   1259,   1045,   679,    1334,   157,    277,    1217,   218,    641,    1089,   136,    247,    1195,   239,    834],
...
for i in range(len(data)):
    maxline = max(data[i])
    minline = min(data[i])
    checksum = checksum + maxline - minline
...
for i in range(len((data))):
    ...
    for j in range(len(data[i])):
        for k in range(len(data[i])):
            if int(data[i][j]%data[i][k]) == 0:
                if j != k:
                    print(data[i][j]/data[i][k])
                    summation = summation + data[i][j]/data[i][k]
